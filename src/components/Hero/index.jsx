...
export function Hero() {
    return (
        <section id="home" className='max-w-screen-xl m-auto flex flex-col md:justify-center h-[100%] md:h-[70vh] space-y-10 sm:space-y-20 pl-8 items-center mb-64'>
            ...
            <a href="#servico">
                <FaArrowDown className="absolute bottom-14 left-44 sm:left-0 sm:bottom-8 text-4xl animate-downarrow" />
            </a>
        </section>
    )
}